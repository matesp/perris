...
// Selectores
$.validator.addMethod("selectorRegion", function(value, element, arg){
    return arg !== value;
}, "Seleccione una Región");
$.validator.addMethod("selectorComuna", function(value, element, arg){
    return arg !== value;
...
$.validator.addMethod("validDate", function(value, element) {
    ...
    if (inputDate < maxDate)
        return true;
    return false;
}, "El año de nacimiento debe ser anterior a 2001");
...
$(function() {
    $( "#formulario" ).validate({
        rules: {
            ...
            region:{
                required: true,
                selectorRegion: "sin-region"
            },
            comuna:{
                required: true,
                selectorComuna: "sin-comuna"
            },
            vivienda:{
                required: true
			},
        ...
        messages:{
            ...
            comuna:{
                required: "Selecciona tu comuna"
            },
            vivienda:{
                required: "Selecciona un tipo de vivienda"
			},
			password:{
